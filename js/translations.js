...
const translations = {
  ko: {
    ...
    schedule: [
      { time: "오전 6:30", desc: "친척·하객 모임, 예비진 준비" },
      { time: "오전 7:00", desc: "대길 행렬" },
      { time: "오전 7:45", desc: "예비진 대기 (장식 착용)" },
      { time: "오전 8:15", desc: "스님 독경" },
      { time: "오전 9:15", desc: "헤어 컷팅·캐스케이드" },
      { time: "오전 10:40", desc: "케덤 배례, 베스나데이푼, 손 잡기" },
      { time: "오전 11:30", desc: "점심 식사" },
      { time: "오후 5:00", desc: "저녁 식사" }
    ]
  },
  en: {
    ...
    sectionScheduleSub: "Programme — March 25, 2026",
    scheduleDate: "🗓 March 25, 2026",
  ...
  km: {
    ...
    venueSubtitle: "គេហដ្ឋានខាងស្រី ភូមិល្វេ យំព្រាំងស្នាយ ស្រុកណូយ កខេត្តកំពត",
    ...
    sectionScheduleSub: "កម្មវិធីថ្ងៃទី ២៥ ខែ មីនា ឆ្នាំ ២០២៦",
    scheduleDate: "🗓 ថ្ងៃទី ២៥ ខែ មីនា ២០២៦",
    ...
    schedule: [
      { time: "ម៉ោង ៦:៣០ នាទីព្រឹក", desc: "ផ្គុំដុំសាច់ញាតិ ភ្ញៀវកិត្តិយស ដើម្បីរៀបចំពិធីថែរពរជិន" },
      { time: "ម៉ោង ៧:០០ នាទីព្រឹក", desc: "ពិធីហែរកំណាត់ចូលមហាជ័យ" },
      { time: "ម៉ោង ៧:៤៥ នាទីព្រឹក", desc: "ពិធាស្នាក៍ណាក់បុរីនជិន (បំពាក់គ្រឿងអលង្ការ)" },
      { time: "ម៉ោង ៨:១៥ នាទីព្រឹក", desc: "និមន្តព្រះសង្ឃសូត្រមន្ត" },
      { time: "ម៉ោង ៩:១៥ នាទីព្រឹក", desc: "ពិធីកាត់សក់បង្កក់សីរី" },
      { time: "ម៉ោង ១០:៤០ នាទីព្រឹក", desc: "ពិធីសំពះកេដឹម បង្វិលពពិល វែសនដីផួន ដីគា បាចផ្កាស្នា ចងដៃ" },
      { time: "ម៉ោង ១១:៣០ នាទីព្រឹក", desc: "អញ្ជើញភ្ញៀវពិសារអាហារថ្ងៃត្រង់" },
      { time: "ម៉ោង ៥ ពេលល្ងាច", desc: "អញ្ជើញភ្ញៀវកិត្តិយសពិសារអាហារពេលល្ងាច ដោយមេត្រីកាព" }
    ]
  }
};
